<template>
  <view class="profile">
    <view class="form">
      <view class="form-item" @tap="goToAvatarSelect">
        <text class="label">头像</text>
        <view class="avatar-wrapper">
          <image class="avatar" :src="userInfo.img || '../../img/1.jpg'" mode="aspectFill"></image>
...
export default {
  ...
  methods: {
    goToAvatarSelect() {
      uni.navigateTo({
        url: '/pages/my/header'  // 直接指向 my 文件夹下的 header.vue
      });
    },
    showPicker(type) {
      ...
      try {
        ...
        const result = await uni.request({
          ...
          data: {
            ...
            img: this.userInfo.img, // 添加头像字段
            surplus: currentUserInfo.surplus || 0,
            isOnline: true
          }
        });
