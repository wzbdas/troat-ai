<template>
  <view class="my">
    ...
    <view v-else class="header" @tap="goToProfile">
      <view class="avatar">
        <image class="avatar-img" :src="userList[0]?.img"  mode="aspectFill"></image>
      </view>
    ...
    <view class="menu-group">
      <view class="menu-item" 
        ...
        :key="index" 
        @tap="checkLoginBeforeAction(() => handleMenuClick(item))"
      >
    ...
    <view class="menu-group">
      <view class="menu-item" @tap="checkLoginBeforeAction(goToSetting)">
...
const handleMenuClick = (item: any) => {
  ...
  } else if (item.text === '我的活动') {  // 添加活动页面跳转
    uni.navigateTo({
      url: '/pages/my/component/actives'
    })
  } else if (item.text === 'AI解读记录') {  // 添加AI解读记录页面跳转
    uni.navigateTo({
      url: '/pages/my/component/aiai'
    })
  }
}
