...
const applyTheme = (color: string, isDark: boolean) => {
  ...
  document.documentElement.style.setProperty('--card-bg-color', isDark ? '#2c2c2c' : '#ffffff')
  document.documentElement.style.setProperty('--border-color', isDark ? '#444' : '#f0f2f5')
  document.documentElement.style.setProperty('--icon-color', isDark ? '#aaa' : '#999')
  document.documentElement.style.setProperty('--secondary-text-color', isDark ? '#aaa' : '#666')
